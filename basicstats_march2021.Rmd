...
```{r}
quast<-read.csv("C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/basicstats/quast_results_allsamples.csv")
allcontigs<-read.csv("C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/basicstats/allsamples-totalnoofcontigs.txt",header=FALSE,sep=":")
...
allcontigsabove1000<-read.csv("C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/basicstats/allsamples-contigsabove1000bps.txt",header=FALSE,sep=":")
...
allcontigsmicrobialabove1000<-read.csv("C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/basicstats/allsamples-microbialabove1000bps.txt",header=FALSE)
...
write.csv(quast_allcontigs3,file="C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/basicstats/quast_results_allsamples_allcounts.csv")

#-----------------------------------------------------------------------------------------------------
quast_all<-read.csv("C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/basicstats/quast_results_allsamples_allcounts.csv",row.names = 1)
...
```{r}
quast<-read.csv("C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/basicstats/quast_results_allsamples_allcounts.csv")
mappedreads<-read.csv("C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/basicstats/all-prokmapped-reads.txt",header=FALSE,sep="\t")
colnames(mappedreads)<-c("samples","prokmappedreads")

quast_prokmappedreads<-merge(quast,mappedreads,by="samples")
write.csv(quast_prokmappedreads,file="C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/basicstats/quast_results_allsamples_allcounts_mappedreads.csv")
sampleinfo<-read.csv("C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/taxonomy/sample_names_ids_withotherfactors_tomedit.2.csv")
...
termitetree<-read.tree("C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/basicstats/rna12-16S_concensus_may2020_newnames.nwk")
...
write.tree(termitetree_129samples,file="C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/1000bps_taxonomy_129taxa_tree.nwk")
...
microbialorfs<-read.csv("C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/basicstats/allnumberof_microbialORFs.txt",header=FALSE,sep="\t")
...
allorfs<-read.csv("C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/basicstats/allnumberof_ORFs.txt",header=FALSE,sep="\t")
...
markergenes<-read.csv("C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/taxonomy/all-cogs-taxonomy-contiginfo-tpm-filtered-corrected.csv",row.names=1) #generated from "taxonomy_march2021.Rmd"
...
pdf(file="C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/prevalance_markergenes_phyla_129samples_0.05thres.pdf",height=8.5,width=13)
p
dev.off()
...
above1000_tpm_cazymes<-read.csv("C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/cazymes_360columns_129samples_rawTPM_march2021.csv",row.names=1) #generated in "functions_march2021.Rmd" with all the filters.
...
functions_microbegenes_spread2<-read.csv("C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/cazymes-taxonomy-allcontigs-5000bps_123samples_march2021.csv",row.names=1)
...
metabolicgenes_tpm<-read.csv("C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/metabolic_pathways_rawtpm_march2021.csv",row.names=1) #generated in "metabolicgenes_march2021.Rmd".
...
```
NOTE1- The prevalance threshold is 5% and it is based on the fact that visually, there is not much difference in 1.5% threshold and 2.5% threshold. But above 5% we lose out of data-points for abundant phyla also.

NOTE2- The prevalance  threshold is 10% for GHs CAZymes, as there are a couple of data-points with higher abundance but lower prevalance in the dataset.
...
NOTE4- The prevalance  threshold is 7.5% for metabolic genes. Increasing it to 10% doesn't change the analysis much as only one data-point gets removed. But to stay consistent with GH CAZymes, 10% was retained.


##MAGs-add rRNA, tRNA , no.of contigs, %mapped reads per MAG-
```{r}
rrna<-read.csv("C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/basicstats/all-bins-rrna.txt",header=FALSE)
colnames(rrna)<-c("Bin.IDs","rrna_count")

trna<-read.csv("C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/basicstats/all-bins-trna.txt",header=FALSE)
colnames(trna)<-c("Bin.IDs","trna_count")

contigcount<-read.csv("C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/basicstats/all-bins-totalcontigcount.txt",header=FALSE)
colnames(contigcount)<-c("Bin.IDs","total_no_of_contigs")

contigmax<-read.csv("C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/basicstats/all-bins-maxcontiglength.txt",header=FALSE)
colnames(contigmax)<-c("Bin.IDs","max_no_of_contigs")

contigmean<-read.csv("C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/basicstats/all-bins-meancontiglength.txt",header=FALSE)
colnames(contigmean)<-c("Bin.IDs","mean_no_of_contigs")

magcoverage<-read.csv("C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/basicstats/all-bin-abundances.txt",header=TRUE,sep="\t")
magcoverage$Bin.IDs<-paste(magcoverage$samples,magcoverage$Genomic_bins,sep=".")
        
        
maginfo<-read.csv("C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/basicstats/659mags_tableinfo.csv") 
...
write.csv(maginfo6,file="C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/basicstats/maginfo_654bins_march2021.csv")
...
```{r}
##1. PULS-
puls<-read.csv("C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/basicstats/bins_pulnames_478mags_expandedversion_jan2021.csv")
...
sulfate<-read.csv("C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/basicstats/mag_sulfatereduction.csv")
...
write.csv(sulfate2,file="C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/sulfatereduction_summedbygenes_march2021.csv")
...
#reductive<-read.csv("C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/basicstats/mag_reductiveacetogenesis.csv") #older version
reductive<-read.csv("C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/kofam-gtdb-ikedaohtsubo-bacterial-metv-hndABCD-HDCR-spreadbinary-ordered.csv")
...
write.csv(reductive_mags2,file="C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/april2_kofam30evalue_functions_data/reductiveacetogenesis_summedbygenes_march2021.csv")

#supplementary table S12-
reductive_sup<-merge(reductive,maginfo,by.x="X.1",by.y="Bin.IDs")

write.csv(reductive_sup,file="C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/reductiveacetogenesis_supptable12.csv")
#-------------------------------------------------------------------------------------------------
##STATS-
...
methano<-read.csv("C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/basicstats/mag_methanogenesis.csv")
...
nitrogen<-read.csv("C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/basicstats/mag_nitrogenmetabolism.csv")
...
nitrogen_contigs<-read.csv("C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/nifHDKENB_operon_metagenomecontigs.csv")
...
morani<-read.csv("C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/phylogenetic_autocorrelation_taxonomy_184columns_129samples_march2021.csv")
...
taxonomy_clr<-read.csv("C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/taxonomy_129samples_123taxa_march2021.csv",row.names = 1)
taxonomy_rawtpm<-read.csv("C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/metagenome-taxonomy-1000bps-bymarkersspread-rawTPM-march2021.csv",row.names=1)
...
above1000_tpm_cazymes<-read.csv("C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/april2_kofam30evalue_functions_data/cazymes_360columns_129samples_rawTPM_april2021.csv",row.names = 1)
...
write.csv(above1000_tpm_cazymes_nozero,file="C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/april2_kofam30evalue_functions_data/cazymes_346columns_128samples_rawTPM_april2021.csv")
...
above1000_tpm_cazymes<-read.csv("C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/cazymes_360columns_129samples_rawTPM_march2021.csv")
...
hydrogenases<-read.csv("C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/metabolic_pathways_rawtpm_march2021.csv")
...
functions_bacteria_genes_spread<-read.csv("C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/bacterial_functionalgenes_all_march2021.csv")
...
#get 126 samples out-
tree<-read.tree("C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/1000bps_taxonomy_126taxa_tree.nwk")
dnew2<-data.frame(label=tree$tip.label)
...
methano_archaea<-read.csv("C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/mcr_archaea_march2021.csv")
...
mainfuncs_tpm<-read.csv("C:/Users/jigyasa-arora.OIST/Dropbox (OIST)/gut bacteria/metagenome analysis/new_stuff/bins/annotation/all_contig_taxonomy/all_functions_Jan2020/march2021/metabolic_pathways_rawtpm_march2021.csv",row.names = 1)
